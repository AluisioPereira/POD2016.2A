 ...
 * @author ajp
 */
public class DaoPessoaMysql {

    private Connection conexao;

    public DaoPessoaMysql() throws IOException, URISyntaxException, ClassNotFoundException, SQLException {
        this.conexao = new ConexaoFabrica().getConectionMysql();
    }
     ...
     * passado por paramento no banco de dados Seleciona o objeto a ser consultado
     * pelo idetificador (nome) e retorna um Pessoa construida caso a
     * operação bem sucessida e retornando null caso não foi encontrodo a pessoa.
     */
